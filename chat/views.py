...
def ask_document(request):  # pylint: disable=too-many-locals
    ...
    try:
        ...
        # Use more of the document text (increased from 8000 to 30000 chars for better context)
        ...
        prompt = (
            ...
            f"Instructions:\n"
            f"- Answer the question based on the actual content of the document above\n"
            f"- Be specific and cite information from the document when possible\n"
            f"- If the answer is not in the document, clearly state that\n"
            f"- Provide a comprehensive answer based on what you can find in the document"
        )
